...
const FarmerDashboardScreen = ({ navigation, route }) => {
  ...
  const fetchStats = () => {
    fetch("https://hydrax.onrender.com/farmer/dashboard", requestOptions)
        ...
        <View style={{ flex: 1, width: "100%" }}>
          <ScrollView style={styles.actionContainer}>
            <OptionList
              ...
              iconName={"md-square"}
              onPress={() =>
                navigation.navigate("farmerviewproduct", { authUser: user })
              }
              onPressSecondary={() =>
