...
import ProductCard1 from "../../components/ProductCard1/ProductCard";
...
const HomeScreen = ({ navigation, route }) => {
  ...
  const fetchProduct = () => {
    fetch(`https://hydrax.onrender.com/products`, headerOptions) //API call
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBarContainer}>
        ...
        <View style={styles.topbarlogoContainer}>
          ...
          <Text style={styles.toBarText}>Agro shop</Text>
        </View>
        <TouchableOpacity
      ...
      <View style={styles.bodyContainer}>
        ...
        <ScrollView nestedScrollEnabled={true}>
          ...
          {/* ALL PRODUCTS */}
          <View style={styles.primaryTextContainer}>
            <Text style={styles.primaryText}>All Products</Text>
          </View>
          {products.length === 0 ? (
            <View style={styles.productCardContainerEmpty}>
              <Text style={styles.productCardContainerEmptyText}>
            ...
            <View style={styles.productCardContainerAll}>
              <FlatList
                refreshControl={
                  <RefreshControl
                    refreshing={refeshing}
