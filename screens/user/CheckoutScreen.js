...
const CheckoutScreen = ({ navigation, route }) => {
  ...
  useEffect(() => {
    if (streetAddress && city && country && email && phone != "") {
      setAddress(`${streetAddress}, ${city},${country},${email},${phone}`);
    } else {
      setAddress("");
    }
    setTotalCost(
      ...
      <ScrollView style={styles.bodyContainer} nestedScrollEnabled={true}>
        ...
        <View style={styles.totalOrderInfoContainer}>
          <View style={styles.list}>
            <Text>Order</Text>
            <Text>NGN {totalCost}</Text>
          </View>
          <View style={styles.list}>
            <Text>Delivery</Text>
            <Text>NGN {deliveryCost}</Text>
          </View>
          <View style={styles.list}>
            <Text style={styles.primaryTextSm}>Total</Text>
            <Text style={styles.secondaryTextSm}>
              NGN {totalCost + deliveryCost}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.listContainer}>
          ...
          >
            ...
            <View>
              {country || city || streetAddress || phone || email != "" ? (
                <Text
      ...
      >
        <View style={styles.modelBody}>
          <View style={styles.modelAddressContainer}>
            ...
            />
            {streetAddress || phone || email || city || country != "" ? (
              <CustomButton
                onPress={() => {
                  setModalVisible(!modalVisible);
