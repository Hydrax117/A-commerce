...
const ProductDetailScreen = ({ navigation, route }) => {
  ...
  const fetchWishlist = async () => {
    ...
    fetch("https://hydrax.onrender.com/wishlist", requestOptions)
  ...
  const handleWishlistBtn = async () => {
    ...
    if (onWishlist) {
      ...
      fetch(
        `https://hydrax.onrender.com/remove-from-wishlist?id=${product?._id}`,
        requestOptions
      )
        .then((response) => response.json())
        .then((result) => {
      ...
      fetch("https://hydrax.onrender.com/add-to-wishlist", addrequestOptions)
        .then((response) => response.json())
        .then((result) => {
          console.log(result);
          if (result.success) {
          ...
          <View style={styles.productInfoTopContainer}>
            ...
            <View style={styles.productDetailContainer}>
              ...
              <View style={styles.productPriceContainer}>
                ...
                <Text style={styles.primaryTextSm}>NGN {product?.price}</Text>
              </View>
            </View>
