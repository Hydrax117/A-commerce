...
const AddProductScreen = ({ navigation, route }) => {
  ...
  const fetchCategories = () => {
    ...
    setIsloading(true);
    fetch("https://hydrax.onrender.com/categories", requestOptions)
  ...
  const upload = async () => {
    ...
    const SERVER_URL = "https://hydrax.onrender.com";

    fetch(`${SERVER_URL}/photos/upload`, ImageRequestOptions)
      .then((response) => response.json())
      .then((response) => {
        console.log(response + "add image");
      })
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      console.log(result.assets[0] + "image picked");
  ...
  const addProductHandle = () => {
    ...
    if (title == "") {
      ...
      fetch("https://hydrax.onrender.com/product", requestOptions)
        .then((response) => response.json())
        .then((result) => {
          console.log(result);
